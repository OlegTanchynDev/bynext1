    ...
    return MaterialApp(
      ...
      theme: ThemeData(
          ...
          textTheme: TextTheme(
              ...
              bodyText2:
                  TextStyle(fontFamily: 'Avenir', fontSize: 16, fontWeight: FontWeight.w300, color: Color(0xFF232456)),
              //buttons
              button: TextStyle(
                fontFamily: 'Avenir',
                fontSize: 18,
      ...
      home: GestureDetector(onTap: () => FocusScope.of(context).requestFocus(new FocusNode()), child: LoginScreen()),
