...
class TokenRepository {
  Future<Token> login(Client http, String login, String password) async {
  ...
  Future<bool> validateCourierLogin(Client http, String login, String version, String token) async {
...
//      throw RestException(cause: errors.first);
  ...
  Future<bool> resetPassword(Client http, String login) async {
    final response = await http.get(
