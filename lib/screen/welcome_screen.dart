                        ...
                        return Column(
                          ...
                          children: <Widget>[
                            ...
                            BlocBuilder<ShiftDetailsBloc, ShiftDetailsState>(builder: (context, shiftState) {
                              final shift = shiftState is ShiftDetailsReady ? shiftState.current : null;
//                          Locale myLocale = Localizations.localeOf(context);
                              String startDate;
                              if (shift?.startDateTime != null) {
                                startDate = DateFormat('M/d/yy').format(shift.startDateTime) +
                                    ' - ' +
  ...
  Widget _buildDispatcherBloc(BuildContext context) {
    return BlocBuilder<ShiftDetailsBloc, ShiftDetailsState>(
        builder: (context, shiftDetailsState) => shiftDetailsState is ShiftDetailsReady && shiftDetailsState.isRegular
            ? Container(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Padding(
                        padding: EdgeInsets.all(9.0),
                        child: Text(shiftDetailsState.current != null ? shiftDetailsState.current.dispatcherName : '')),
                  ],
                ),
              )
            : Container());
