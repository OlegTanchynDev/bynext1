                    ...
                    return Column(
                      ...
                      children: <Widget>[
                        Container(
                          ...
                          child: CircleAvatar(
                            backgroundImage: profileState.profile?.profilePhotoUrl != null ?  NetworkImage(mediaUrl + profileState.profile.profilePhotoUrl) : null,
                        ...
                        BlocBuilder<ShiftDetailsBloc, ShiftDetailsState>(builder: (context, shiftState) {
                          final shift = shiftState is ShiftDetailsReady ? shiftState.shift : null;
//                          Locale myLocale = Localizations.localeOf(context);
                          String startDate;
                          if (shift?.startDateTime != null) {
                            startDate = DateFormat('M/d/yy').format(shift.startDateTime) + ' - ' + DateFormat.jm().format(shift.startDateTime);
                          }
                          return Column(
                              ...
                              Container(
                                ...
                                child: Column(
                                  ...
                                  children: <Widget>[
                                    ...
                                    Padding(
                                        padding: EdgeInsets.all(9.0),
                                        child: Text(startDate != null ? startDate : '')),
                                  ],
                                ),
                              ),
                              const SizedBox(
                              ...
                              Container(
                                ...
                                child: Column(
                                  ...
                                  children: <Widget>[
                                    ...
                                    Padding(
                                        padding: EdgeInsets.all(9.0),
                                        child: Text(shift != null ? shift.dispatcherName : '')),
                                  ],
                                ),
                              ),
                            ],
                                ...
                                children: <Widget>[
                                  Padding(
                                    ...
                                    child: RichText(
                                      ...
                                      TextSpan(
                                          text: 'Estimated Earnings: ', style: TextStyle(fontWeight: FontWeight.w400)),
                                      TextSpan(
